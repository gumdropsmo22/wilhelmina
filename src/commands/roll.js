...
const diceConfig = {
  d4: { sides: 4, name: '𝑸𝑼𝑨𝑫𝑹𝑨𝑵𝑻', decor: '❖', tone: 'sharp, impatient' },
  d6: { sides: 6, name: '𝑽𝑬𝑪𝑻𝑶𝑹', decor: '✦', tone: 'directional, structured, efficient, logical' },
